...
uint8_t attDeviceName[GAP_DEVICE_NAME_LEN]= "Control-Box";
...
gapBondParams_t gapBondParams = {
    ...
    .KeySize              = 16,
    .removeLRUBond        = false,
    .KeyDistList          = GAPBOND_KEYDIST_SENCKEY | GAPBOND_KEYDIST_SIDKEY | GAPBOND_KEYDIST_SSIGN | GAPBOND_KEYDIST_MENCKEY | GAPBOND_KEYDIST_MIDKEY | GAPBOND_KEYDIST_MSIGN,
    .eccDebugKeys         = false,
...
uint8_t KeyDistList             =    GAPBOND_KEYDIST_SENCKEY | GAPBOND_KEYDIST_SIDKEY | GAPBOND_KEYDIST_SSIGN | GAPBOND_KEYDIST_MENCKEY | GAPBOND_KEYDIST_MIDKEY | GAPBOND_KEYDIST_MSIGN;
...
void setBondManagerParameters()
{
    ...
    GAPBondMgr_SetParameter(GAP_ADV_WL_POLICY_ANY_REQ, sizeof(uint8_t), &autoSyncAL);
